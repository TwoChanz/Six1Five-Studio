...
async function updateFloydThumbnail() {
  try {
    // Update Floyd Stadium project (ID 1) with the aerial cover photo
    const coverPhotoPath = "/assets/floyd-stadium-aerial.jpg";
